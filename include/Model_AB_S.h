...
public:
    ...
    double Hc, Fc, Fg; //Hc: effective Haminton in canonical ensemble; Fc: free energy in canonical ensemble; Fg: free energy in grand canonical ensemble
...
private:
    ...
    string EnsembleType;
    double N;  //polymerization of copolymer. 
    double dyita; //difference of yita between grand canonical ensemble and canonical ensemble
    ...
    double phiA_avg, phiB_avg, phiS_avg; //mean volume fraction of A block, B block and solvents
    double up, us; //chemical potential of copolymer and solvent.
    double zp, zs; //activity of copolymer and solvent.
