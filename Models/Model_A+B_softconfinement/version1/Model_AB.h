...
private:
    ...
    /*B denotes brush chain while A is free chain chain. so fA was defined to be volume fraction of brush chain with fB=1-fA*/
    double graft_density;
    double graft_area;
    double fA, fB;       
    double aA, aB;      // segment length
    double chiN;        // Flory-Huggins interation parameters
    double dsA, dsB;    // dsA and dsB is time step of brush and free chain 
    double lamA, lamB, lamYita;
    arma::uword sA, sB;   //here sA and sB means length of brush and free chains
