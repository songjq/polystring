 ...
 * Created at 2014.6.6
 *
 * Model_ABW is a class derived from Model describing a
 *           linear A-B diblock copolymer melt and wall particles
 * confined in a Slab.
...
#ifndef polyorder_model_abw_h
#define polyorder_model_abw_h
...
class Model_ABW:public Model{
public:
    Model_ABW(){}
	Model_ABW(const string config_file);
...
private:
    ...
    Density *phiA_begin, *phiA_end, *phiB_begin, *phiB_end;
